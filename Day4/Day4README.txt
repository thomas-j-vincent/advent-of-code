...
"to_remove" is empty the loop ends. From there we loop through all the values in to_remove, replacing every value in the array with a ., allowing it to be 
used next loop. 
The total is then increased and at the end of the loop is printed
